...
pub const HEAP_START: usize = 0o_000_001_000_000_0000; // 1 Gib
...
#[no_mangle]
pub extern fn __rust_reallocate_inplace(_ptr: *mut u8, size: usize, _new_usize: usize, _align: usize) -> usize {
    size
}
